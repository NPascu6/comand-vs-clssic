...
// ---------------------------------------------------------------------------
// The same seeded "truth" the .NET InMemoryUpstream uses, mirrored for the
// mock data source so the UI is fully interactive offline and produces
// outcomes identical to the backend.
// ---------------------------------------------------------------------------
