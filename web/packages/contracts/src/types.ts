// ---------------------------------------------------------------------------
// TypeScript mirror of the .NET contracts (Atlas.Upstream.Contracts +
// Atlas.Functional.Commands). Enums are string-literal unions so they match the
// JSON the ASP.NET API emits (JsonStringEnumConverter) byte-for-byte.
//
// This is the frontend equivalent of the backend's owned contracts project:
// one place every vertical slice imports its domain language from.
// ---------------------------------------------------------------------------
...
// --- the command + its outcome (mirror of the functional handler) ----------
