...
/// <summary>
/// One deterministic dataset that stands in for every upstream during dev/test.
/// In production each <c>Sources/</c> adapter would fetch from its real system
/// (CRM, DMS, Ledger, PolicyHub); here they all read slices of this seed so the
/// samples and tests run offline and identically.
/// </summary>
public sealed class SeedData
{
    ...
    public static SeedData Build()
    {
        ...
        }.ToDictionary(c => c.CoInvestmentId);
